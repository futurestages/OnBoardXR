            ...
            <Container>
              ...
              <Navbar.Collapse>
                <Nav
                  ...
                  style={{ maxHeight: "100px", color: "yellow" }}
                  navbarScroll
                >
                  {data &&
                  ...
                  {/* <Nav.Link style={{ color: 'yellow' }} href="#action1">Tickets</Nav.Link>
                  <Nav.Link style={{ color: 'yellow' }} href="#joinUs">Submit</Nav.Link>
                  <Nav.Link style={{ color: 'yellow' }} href="#action1">Documentation</Nav.Link>
                  <Nav.Link style={{ color: 'yellow' }} href="#about">About</Nav.Link>
 */}
                </Nav>
          ...
          <Container id="main">
            <Row>
              ...
              <Col sm={12} md={6} lg={6}>
                ...
                {/* <Card className="text-dark mobile_res">

                <Image className="card-img" src={data && data.masterCard.image}></Image>
                <Card.ImgOverlay  className=" card-overlay-gray d-flex flex-column justify-content-between ">

                  <div className="h3 ">
                    <p className="text-white text-decoration-none">{list.title}</p>
                  </div>
                  <div className="d-flex justify-content-between ">
                    <div className='m-1'>
                      <img src={list.leftOverlay} height='60px' width='60px' />
                      <p className="text-white text-decoration-none">
                        {list.leftOverlayText}</p>
                    </div>
                    <div className='align-items-right m-3'>
                      <img src={list.rightOverlay} height='50px' width='50px' />
                      <p className="text-white text-decoration-none">
                       {list.rightOverlayText}</p>
                    </div>
                  </div>
                  <div className="h5">
                  <a className="text-white text-decoration-none" href={`/${data && data.masterCard.link}`}>{data && data.masterCard.heading}</a>
                  <br></br>
                  <h6 className="text-white text-decoration-none "> {data && data.masterCard.name} </h6>
                </div>
                  <div className="d-flex justify-content-between ">
                    <img src={list.artist} width='75px' height='75px' />
                    <div className='align-items-right'><Button style={{ borderWidth: '0px', borderRadius: '35px', backgroundColor: 'yellow', color: 'black' }}>Enter</Button></div>
                  </div>
                </Card.ImgOverlay>
                ...
                >
                  ...
                  <Card.ImgOverlay className="overlay_bottom_res card-overlay2-black d-flex flex-column justify-content-between  p-4">
                    ...
                    <div className="d-flex justify-content-between m-2">
                      ...
                      <div className="align-items-right m-2">
                        <Button
                          className="enter__btn"
                          onClick={(e) => {
                            e.preventDefault();
                ...
                <Card.Body>
                  ...
                  <div className="d-flex justify-content-between align-items-center">
                    <Text
                      ...
                      className="weight-400 text-white font-size-20"
                    >
                      <a href={data && data.submitLink}>Send a proposal</a> for
                      our next seasonal series to showcase and monetize your
                      performance.
                    </Text>
                  </div>
                </Card.Body>
